...
parser.add_argument('--target', action="store", type=str, required=True, choices=['MD', 'clusters'])
...
parser.add_argument("--images", action="store", type=str, choices=['onh', 'thick'], default='thick')
